  ...
  return (
    <div>
      ...
      <select onChange={handleExperienceChange} value={selectedExperience?.experience_uuid || ''}
        className="flex flex-col px-auto sm:px-72 gap-y-2 text-sm w-full mt-1 p-2 rounded-md border border-gray-300 shadow-sm focus:ring-yellow-700 focus:border-yellow-700 focus:outline-none"
        >
