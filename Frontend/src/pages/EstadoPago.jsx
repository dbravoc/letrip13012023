...
const FormularioPago = ({ experienceCard }) => {
  ...
  const features = [
      ...
      { name: 'Estado de reserva', description: "Estamos validando tu pago, esto puede tardar máximo 1 hora"}
    ];


  return (
    <div className="flex flex-col mx-auto p-4 bg-black shadow rounded-lg items-center h-screen">
      <h1 className="text-3xl font-bold tracking-tight text-gray-50 mb-4">Detalles de tu reserva</h1>
