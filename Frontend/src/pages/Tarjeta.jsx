    ...
    <div className="mx-0 grid sm:grid-cols-2 grid-cols-1 items-center gap-x-8 gap-y-8 sm:px-6 sm:py-8"> 
      ...
      <div>
        <h2 className="text-3xl font-bold tracking-tight text-gray-50 mb-4">{selectedExperience.experience_name}</h2>
         ...
         <div>
            <p className="text-sm py-5 leading-6 text-gray-50">{selectedExperience.experience_description_instructor_message}</p>
        |</div>
          ...
          <div className="-mt-2 p-2 flex justify-center lg:mt-0 lg:w-full lg:max-w-md lg:flex-shrink-0">
            <div className="rounded-2xl bg-black py-10  text-center ring-inset lg:flex lg:flex-col lg:justify-center lg:py-16">
              ...
              <div class="sm:col-span-3">
                  ...
                  <div class="mt-2">
                  <label for="fechas" class="block text-sm font-medium leading-6 text-gray-300">Próximas fechas</label>
                  <select id="fechas" name="fechas" autocomplete="fechas" class="block w-full rounded-md border-0 py-1.5 text-gray-50 bg-gray-900 shadow-sm ring-1 ring-inset ring-gray-700 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-6">
                    <option>1 al 4 de febrero</option>
                    <option>8 al 11 de febrero</option>
                    <option>15 al 18 de febrero</option>
                  </select>
                  </div>
                  
                  <div class="mt-2">
                  <label for="N_Personas" class="block text-sm font-medium leading-6 text-gray-300">N° Personas</label>
                  <select id="N_Personas" name="N_Personas" autocomplete="N_Personas" class="block w-full rounded-md border-0 py-1.5 text-gray-50 bg-gray-900 shadow-sm ring-1 ring-inset ring-gray-700 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-6">
                    <option>1</option>
                    <option>2</option>
                    <option>3</option>
                    <option>4</option>
              ...
              <div className="mx-auto mt-4 max-w-xs px-8 justify-center">
                <p className="text-base font-semibold text-gray-300">Valor total</p>
                ...
                <button 
                  ...
                  className="mt-10 block w-full rounded-md bg-gray-50 px-3 py-2 text-center text-xl font-semibold text-gray-900 shadow-sm hover:bg-gray-700 hover:text-gray-50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                >
                  <strong>Pagar</strong>
                </button>
