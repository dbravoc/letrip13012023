            ...
            <div className='md:grid md:grid-cols-5 flex flex-col gap-x-8'>
              ...
              <h3 className="rounded-2xl bg-yellow-100 text-gray-900 px-4 py-2 text-xl text-center font-bold mb-10">Ingresa tus datos</h3>
                ...
                />
                    ...
                    Acepto los <a href="https://www.letriplab.com/tyc" target="_blank" class="font-semibold flex justify-center px-2 underline rounded-lg text-black bg-letrip hover:bg-black hover:text-letrip">términos y condiciones</a>
                    </label>
                  </div>
              </div>
