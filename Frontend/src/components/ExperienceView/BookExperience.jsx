...
const BookExperience = ({ experienceCard }) => {
  ...
  return (
    <div className="mx-0 md:px-40 px-8 pb-20 tracking-tight border-t-2 text-gray-900">
      {selectedExperience ? (
        <>
        <div className='pt-2'>
            ...
            <div className='md:grid md:grid-cols-5 flex flex-col gap-x-8'>
              ...
              <h3 className="rounded-2xl bg-yellow-100 text-gray-900 px-4 py-2 text-xl text-center font-bold mb-10">Ingresa tus datos</h3>
                ...
                <input
                  ...
                  className="mb-10 text-lg font-semibold block w-full p-2 border-b-2 bg-transparent border-yellow-100 text-gray-900 text-center focus:outline-none border-l-0 border-r-0 border-t-0"
                />
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="mb-3 text-lg font-semibold block w-full p-2 border-b-2 bg-transparent border-yellow-100 text-gray-900 text-center focus:outline-none border-l-0 border-r-0 border-t-0"
                />
