 //MAILGUN
 const sendReservationEmail = async (formData, selectedExperience, item, players, totalPriceFull) => {
    const emailData = {
      to: 'david@letrip.com',
    ...
    try {
      const response = await fetch('http://letrip13012023-backend-lawitec.vercel.app/send-email', {
        method: 'POST',
        headers: {
