...
<div className="flex flex-col justify-center items-center md:p-10 bg-white border-white border-2 rounded-2xl md:grid md:grid-cols-5 md:justify-start">
    ...
    <div className="flex col-span-2 flex-col md:p-10 bg-white border-white border-2 rounded-2xl">
    ...
    <div className="flex col-span-1 flex-col md:p-10  bg-white border-white border-2 rounded-2xl">
  ...
  <div className='col-span-1'>
    <div className="flex flex-col md:p-10  bg-white border-white border-2 rounded-2xl">
